...
module sir_5_1_0
	...
	s : [0..5] init 5;
	i : [0..5] init 1;
	r : [0..5] init 0; [] s=5 & i=1 & r=0 -> ((5*alpha)/(5*alpha+6*beta)):(s'=4) & (i'=2) & (r'=0) + ((1*beta)/(5*alpha+6*beta)):(s'=5) & (i'=0) & (r'=1) + ((5*beta)/(5*alpha+6*beta)):(s'=5) & (i'=1) & (r'=0);
...
label "bscc_k_0_ge2" = s=0 & i=0 & r=6 | s=1 & i=0 & r=5 | s=2 & i=0 & r=4 | s=3 & i=0 & r=3 ;
