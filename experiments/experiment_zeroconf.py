...
logging.basicConfig(
    filename=f"temp-files/log/{str(datetime.time(datetime.now()))}_experiment_zeroconf_smc.log",
    level=logging.DEBUG,
)
...
def main(cfg_name: str, mode: EvaluationMode):
    cfg = ExperimentZeroconfConfig.get_config(cfg_name)
...
if __name__ == "__main__":
    ...
    for cfg in ExperimentZeroconfConfig.get_all_config_names():
        print(cfg)
