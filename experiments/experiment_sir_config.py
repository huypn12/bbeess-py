...
class ExperimentSirConfig(ExperimentConfig):
    _config = {
        "sir_3_1_0": {
            ...
            "smc_mh_trace_len": 5,
            "abc_threshold": 0.25,
            "prism_model_file": "./data/prism/sir_3_1_0.pm",
            "prism_props_file": "./data/prism/sir_3_1_0.pctl",
            "interval": (0, 0.1),
        ...
        "sir_5_1_0": {
            ...
            "smc_mh_trace_len": 50,
            "abc_threshold": 0.25,
            "prism_model_file": "./data/prism/sir_5_1_0.pm",
            "prism_props_file": "./data/prism/sir_5_1_0.pctl",
            "interval": (0, 0.1),
            "true_param": np.array([0.03405521326944327, 0.08773454035144489]),
            # "observed_data": np.array([1098, 1377, 1296, 1312, 1466, 3451]),
            "observed_data": np.array([2721, 1316, 871, 719, 1021, 3352]),
            "observed_labels": [
                "bscc_0_0_6",
                "bscc_1_0_5",
                "bscc_2_0_4",
        ...
        "sir_5_1_0_a": {
            ...
            "smc_mh_trace_len": 50,
            "abc_threshold": 0.25,
            "prism_model_file": "./data/prism/sir_5_1_0_a.pm",
            "prism_props_file": "./data/prism/sir_5_1_0_a.pctl",
            "interval": (0, 0.1),
            "true_param": np.array([0.03405521326944327, 0.08773454035144489]),
        ...
        "sir_10_1_0": {
            ...
            "smc_mh_trace_len": 50,
            "abc_threshold": 0.25,
            "prism_model_file": "./data/prism/sir_10_1_0.pm",
            "prism_props_file": "./data/prism/sir_10_1_0.pctl",
            "interval": (0, 0.1),
        ...
        "sir_10_1_0_a": {
            ...
            "smc_mh_trace_len": 50,
            "abc_threshold": 0.25,
            "prism_model_file": "./data/prism/sir_10_1_0_a.pm",
            "prism_props_file": "./data/prism/sir_10_1_0_a.pctl",
            "interval": (0, 0.1),
            "true_param": np.array([0.025490115891226895, 0.06929809986640066]),
        ...
        "sir_15_1_0": {
            ...
            "smc_mh_trace_len": 50,
            "abc_threshold": 0.25,
            "prism_model_file": "./data/prism/sir_15_1_0.pm",
            "prism_props_file": "./data/prism/sir_15_1_0.pctl",
            "interval": (0, 0.1),
        ...
        "sir_15_1_0_a": {
            ...
            "smc_mh_trace_len": 50,
            "abc_threshold": 0.25,
            "prism_model_file": "./data/prism/sir_15_1_0_a.pm",
            "prism_props_file": "./data/prism/sir_15_1_0_a.pctl",
            "interval": (0, 0.1),
            "true_param": np.array([0.011499276183591657, 0.06211051606863456]),
