from experiments.experiment_bees_config import ExperimentBeesConfig
...
logging.basicConfig(
    filename=f"temp-files/log/{str(datetime.time(datetime.now()))}_experiment_bees_smc.log",
    level=logging.DEBUG,
)
...
def main(cfg_name: str, mode: EvaluationMode):
    cfg = ExperimentBeesConfig.get_config(cfg_name)
...
if __name__ == "__main__":
    ...
    for cfg in ExperimentBeesConfig.get_all_config_names():
        print(cfg)
